...
public class MBTIPersonalityTest {
    ...
    private static char[] arrayJvsPResponses = new char[10];
    private static char[] finalResponse = new char[4];
    ...
    private static String[] arrayEvsI = {
    ...
    private static String[] arraySvsN = {
    ...
    private static String[] arrayTvsF = {
    ...
    private static String[] arrayJvsP = {
            "A. Organized, orderly",
